        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        <div className="relative w-full max-w-5xl pointer-events-auto rounded-3xl bg-linear-to-b from-[#1a1a2e] to-[#16213e] border border-white/10 shadow-2xl shadow-purple-900/30">

                            {/* Header */}
                            <div className="flex items-center justify-between px-8 py-5 bg-linear-to-r from-pink-600/90 to-rose-600/90 backdrop-blur-md rounded-t-3xl">
                                <h2 className="text-2xl font-black text-white tracking-tight">
                                    📖 How to Play HeartSweeper
                                </h2>
                                <button onClick={onClose} className="p-2 rounded-full bg-white/20 hover:bg-white/30 transition-colors" aria-label="Close" >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-8 py-6">
                                ...
                                <div className="space-y-4">
                                    <Section icon={<Trophy size={20} className="text-yellow-400" />} title="Goal" description="Find all the hidden hearts ❤️ and carrots 🥕 on the board without clicking on any bombs 💣!" />
                                    <Section icon={<MousePointer size={20} className="text-blue-400" />} title="How It Works" description="Each tile hides either a safe item or a bomb. Click a tile to reveal it. The number on a tile tells you how many bombs are nearby." />
                                    <Section icon={<Heart size={20} className="text-pink-400" />} title="Hearts ❤️" description="Hearts are safe! Collecting them adds to your score. Try to find them all." />
                                    <Section icon={<Carrot size={20} className="text-orange-400" />} title="Carrots 🥕" description="Carrots are also safe! They count towards your total collected items." />
                                    <Section icon={<Bomb size={20} className="text-red-400" />} title="Bombs 💣" description="If you click a bomb, the game is over! Use the number clues to avoid them." />
                                    <Section icon={<Timer size={20} className="text-green-400" />} title="Timer ⏱️" description="Timer starts on first click. Finish faster for a better leaderboard rank!" />
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="rounded-2xl bg-linear-to-r from-purple-900/40 to-pink-900/40 border border-purple-500/20 p-4">
                                    ...
                                    <button onClick={onClose} className="w-full py-3.5 rounded-2xl bg-linear-to-r from-pink-600 to-rose-600 text-white font-bold text-lg hover:from-pink-500 hover:to-rose-500 transition-all shadow-lg shadow-pink-900/30" >
                                        Got it! Let&apos;s Play 🎮
                                    </button>
                                </div>
                            </div>
