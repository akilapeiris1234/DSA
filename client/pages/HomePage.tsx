  ...
  return (
    <div className="relative min-h-screen flex flex-col font-sans text-white overflow-x-hidden selection:bg-rose-500/20">
      ...
      <div className="fixed inset-0 -z-10">
        <Image src={AUTH_IMAGES.homeBackground} alt="HeartSweeper Background" fill priority className="object-cover brightness-[0.82]" />
      ...
      <main className="grow flex items-center justify-center pt-20 pb-24 md:pt-28 lg:pt-32 px-5">
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="w-full max-w-6xl text-center" >
          <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }} className="relative" >
            ...
            <motion.h1 variants={fadeInUp} className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl 2xl:text-[10rem] font-black tracking-tighter leading-none mb-6 md:mb-8" >
            ...
            <motion.p variants={fadeInUp} className="mx-auto max-w-2xl lg:max-w-3xl text-lg md:text-xl lg:text-2xl text-rose-50/85 font-medium leading-relaxed mb-10 md:mb-14" >
            ...
            <motion.div variants={fadeInUp}>
              <Link href="/login">
                <motion.button whileHover={{ scale: 1.05, y: -4 }} whileTap={{ scale: 0.96 }} className="group inline-flex items-center gap-3 rounded-2xl bg-linear-to-r from-rose-600 to-fuchsia-700 px-8 py-5 md:px-12 md:py-7 text-lg md:text-2xl font-bold shadow-2xl shadow-rose-950/50 transition-all hover:shadow-rose-900/70" >
