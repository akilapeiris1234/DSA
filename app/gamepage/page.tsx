...
import { useLogoutRedirect } from '@/client/features/auth/hooks/useLogoutRedirect';

// Game hooks (each encapsulates a single concern — High Cohesion)
import { useGameTimer, useGameBoard, useGif, useLeaderboard } from '@/client/features/game/hooks';
import { useLeaderboardListener } from '@/client/features/game/hooks/useLeaderboard';
